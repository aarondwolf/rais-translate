...
label variable radiccnpj "Radical of the establishment's CNPJ (8 positions, without zeros to the left)"
...
label variable ocupacao94 "CBO 94 Occupation"
...
label variable cepestab "CEP Estab"
label variable muntrab "Mun Trab"
label variable razaosocial "Corporate name"
