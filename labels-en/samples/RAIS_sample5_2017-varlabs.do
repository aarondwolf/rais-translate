...
label variable remdezr "Workers' remuneration in December, in minimum wages"
label variable remdezembro "Average worker remuneration in December, in nominal value"
label variable remmedr "Average salary for the year in minimum wages"
label variable remmedia "Average salary for the year in nominal value"
